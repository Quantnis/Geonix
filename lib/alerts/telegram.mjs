...
// USP feature: Geonix becomes a conversational intelligence agent via Telegram
...
export class TelegramAlerter {
  ...
  _buildEvaluationPrompt() {
    return `You are Geonix, an elite intelligence alert evaluator for a personal OSINT monitoring system. You analyze signal deltas from a 25-source intelligence sweep and decide if the user needs to be alerted via Telegram.
