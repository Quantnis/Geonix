...
export function getLanguage() {
  // Geonix_LANG takes priority to avoid conflict with Linux system LANGUAGE variable
  const lang = (process.env.Geonix_LANG || process.env.LANGUAGE || process.env.LANG || DEFAULT_LOCALE)
    .toLowerCase()
    .slice(0, 2);
