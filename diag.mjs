#!/usr/bin/env node
// Geonix Diagnostic — run this to find out why server.mjs fails silently
// Usage: node diag.mjs

console.log('=== Geonix DIAGNOSTICS ===\n');
...
try {
  ...
  if (err.code === 'EADDRINUSE') {
    ...
    console.error('   A previous Geonix instance may still be running.');
